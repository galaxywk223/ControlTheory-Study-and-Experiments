...
OUTPUT_DIR = REPO_ROOT / "generated" / "01_lti_stability"
FIGURE_DIR = REPO_ROOT / "figures" / "01_lti_stability"
...
def main() -> None:
    ...
    save_state_plot(t_grid, states, FIGURE_DIR / "reproduced_state_trajectories.png")
    save_phase_portrait(FIGURE_DIR / "reproduced_phase_portrait.png")
