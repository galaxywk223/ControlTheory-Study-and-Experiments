...
exportgraphics(fig1, fullfile(figureDir, 'reproduced_state_trajectories_matlab.png'), 'Resolution', 160);
close(fig1);
...
exportgraphics(fig2, fullfile(figureDir, 'reproduced_phase_portrait_matlab.png'), 'Resolution', 160);
close(fig2);
...
reportPath = fullfile(generatedDir, 'lyapunov_report_matlab.json');
